...
expect_code 401 GET "${BASE_URL}/pushups/support" ""
...
expect_code 200 GET "${BASE_URL}/pushups/support" "$SMOKE_READ_TOKEN"
...
expect_code 200 GET "${BASE_URL}/pushups/support" "$SMOKE_ADMIN_TOKEN"
